...
PICS = (environ.get('PICS' ,'https://telegra.ph/file/fc3b2bfc18aeb8d575c6b.jpg')).split()
BOT_START_TIME = time()
...
START_MESSAGE = environ.get('START_MESSAGE', '👋 𝙃𝙀𝙔 {user}\n\n𝙈𝙔 𝙉𝘼𝙈𝙀 𝙄𝙎 {bot},\n𝙸𝙄 𝘼𝙈 𝘼 𝙋𝙊𝙒𝙀𝙍𝙁𝙐𝙇 𝙂𝙍𝙊𝙐𝙋 𝙈𝘼𝙉𝘼𝙂𝙀𝙍 + 𝘼𝙐𝙏𝙊𝙁𝙄𝙇𝙏𝙀𝙍 𝘽𝙊𝙏 𝘼𝘿𝘿 𝙈𝙀 𝙏𝙊 𝙔𝙊𝙐𝙍 𝙂𝙍𝙊𝙐𝙋  𝘼𝙉𝘿 𝙈𝘼𝙆𝙀 𝙈𝙀 𝘼𝘿𝙈𝙄𝙉 𝙄 𝙒𝙄𝙇𝙇 𝙋𝙍𝙊𝙑𝙄𝘿𝙀 𝘼𝙇𝙇 𝙈𝙊𝙑𝙄𝙀𝙎 🍿 𝙈𝙔 𝙊𝙒𝙉𝙀𝙍 @LiZarD_amc...')
